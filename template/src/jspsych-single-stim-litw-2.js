...
jsPsych.plugins["single-stim-2"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    trial.prompt = (trial.withTouch) ? trial.promptWithTouch : trial.prompt;
    ...
    var mouse_listener = function(e) {
      var whichStim = $(e.target).attr("class"),
      key_press;

      // get the equivalent key codes
      if (whichStim === "left-stim") {
        key_press = 49;
      } else if (whichStim === "right-stim") {
        key_press = 50;
      }
    ...
    display_element.find("img").click(mouse_listener);
